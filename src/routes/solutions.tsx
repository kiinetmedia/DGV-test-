...
const PROCESS_ITEMS: FlatAtlasItem[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        specs: [
          { k: "Colours", v: "Up to 8 Colors + Online coating" },
          { k: "Standard", v: "ISO Standards" },
        ],
      },
    ],
    pairings: [
  ...
  },
  {
    ...
    tagline: "The industry standard for high-volume label production",
    description:
      "A high-speed flexo printing process purpose-built for self-adhesive labels and pre-printed or plain barcode labels. Flexographic printing delivers exceptional print consistency, rapid production speeds, and inline finishing, making it the preferred technology for large-volume label manufacturing.",
    insight:
      "Designed for efficiency and precision, flexographic printing enables printing, varnishing, laminating, die-cutting, and rewinding in a single continuous press pass. This streamlined workflow reduces production time, lowers manufacturing costs, and ensures consistent quality across every label in the run.",
    image: img(3),
    imageAlt:
    ...
    sections: [
      ...
      },
      {
        ...
        heading: "Output specifications",
        specs: [
          { k: "Substrates", v: "Self-adhesive paper, PP (BOPP), PET & specialty label stocks" },
          { k: "Inline operations", v: "Lamination, UV varnish, die-cutting, slitting & rewinding" },
          { k: "Ink systems", v: "Water-based, UV-curable & LED UV" },
          { k: "Press format", v: "Narrow web" },
        ],
      },
    ],
    pairings: [
