...
const PRODUCTS: ProductCategory[] = [
  ...
  },
  {
    ...
    sub: [
      { name: "Product Labels",         href: "/products#product-barcode-labels" },
      { name: "Barcode Labels",         href: "/products#barcode-only-labels" },
      { name: "Pharmaceutical Labels",  href: "/products#pharmaceutical-labels" },
      { name: "Cosmetic Labels",        href: "/products#cosmetic-labels" },
      { name: "FMCG Labels",            href: "/products#fmcg-food-labels" },
      { name: "Food Labels",            href: "/products#fmcg-food-labels" },
      { name: "Chemical Labels",        href: "/products#chemical-labels" },
      { name: "Vinyl / Transparent Labels", href: "/products#vinyl-transparent-labels" },
      { name: "Tamper-Evident Labels",  href: "/products#tamper-evident-labels" },
    ],
  },
  {
  ...
  },
  {
    ...
    sub: [
      ...
      { name: "Estimate Pads",         href: "/products#estimate-pads" },
  ...
  },
  {
    ...
    sub: [
      { name: "Kraft Stand-Up Pouches",      href: "/products#kraft-pouches" },
      { name: "Zipper Resealable Pouches",   href: "/products#zipper-pouches" },
      { name: "Spouted Pouches",             href: "/products#spouted-pouches" },
      { name: "Flat Bottom Pouches",         href: "/products#flat-bottom-pouches" },
      { name: "Metallized & Foil Pouches",   href: "/products#metallized-pouches" },
    ],
  },
  {
    title: "Mono Cartons",
    ...
    sub: [
      { name: "Tuck-End Cartons",              href: "/products#tuck-end-cartons" },
      { name: "Auto-Bottom Cartons",           href: "/products#auto-bottom-cartons" },
      { name: "Pharmaceutical Cartons",        href: "/products#pharma-cartons" },
      { name: "Cosmetic & Personal Care Cartons", href: "/products#cosmetic-cartons" },
      { name: "FMCG & Food Cartons",           href: "/products#fmcg-cartons" },
    ],
  },
];
